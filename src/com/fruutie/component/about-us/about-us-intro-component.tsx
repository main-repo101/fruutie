...
export function about_us_intro_component(): JSX.Element {
    ...
    return <>
        <div id={NavPath.ABOUT_US_INTRO.ID_ATTR}className="intro flex 
            ...
            sm:text-amber-100
            relative">
                <span className='z-10'>Introduction</span>
            <span className="bg
            flex
            absolute
            w-[100%]
